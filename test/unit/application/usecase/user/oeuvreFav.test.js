...
const { albumRawOneArtist } = require("../../../interfaces/serializers/fixtures/albumFixture.js")
const { rawTrackWithOneArtist } = require("../../../interfaces/serializers/fixtures/albumTrackFixture.js")
    ...
    describe("invalid and valid cases", () => {
        ...
        it("should throw error bad auth token", async () => {
            ...
            const error = await catchError(async () => {
                await OeuvreFav(userToken, idOeuvre, serviceLocator)
            })
        ...
        it("should throw incrorrect id oeuvre error", async () => {
            ...
            mockSpotifyRepository.getSpotifyAlbums = jest.fn((idOeuvre) => {
                throwStatusCode("400", "invalid id");
            })
        ...
        it("should put an album", async () => {
            ...
            const result = await OeuvreFav(userToken, idOeuvre, serviceLocator)
