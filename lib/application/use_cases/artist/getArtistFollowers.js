...
module.exports = async (artistId, userToken, {accessTokenManager,userRepository, spotifyRepository, followRepository, friendRepository}) => {
    ...
    const followersFriendsList = await followRepository.getFriendsFollowing(artistId,4)
    const followersWithoutFriends = await followRepository.getArtistFollowersWithoutFriends(artistId, 4)
