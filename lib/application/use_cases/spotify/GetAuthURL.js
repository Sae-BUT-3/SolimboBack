...
module.exports = (mobile) => {
    ...
    console.log(`https://accounts.spotify.com/authorize?client_id=${process.env.CLIENT_ID}&response_type=${'code'}&redirect_uri=${encodeURI(url_redirection)}&show_dialog=${'true'}&scope=${spotifyScopes.join(' ')}`)
