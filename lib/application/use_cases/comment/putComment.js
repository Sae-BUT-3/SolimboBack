...
module.exports = async (
    ...
    description,
    userToken,
    {friendRepository,accessTokenManager,commentRepository,userRepository,notificationRepository}) => {
    ...
    if(commentRaw.utilisateur.id_utilisateur !== id_utilisateur)
        await notificationRepository.persist(deserializeNotification("replyComment",utilisateur,comment.utilisateur.id_utilisateur,commentRaw.id_com))
