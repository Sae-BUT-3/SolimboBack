...
module.exports = async (idOeuvre, userToken, description, note,type, {accessTokenManager, userRepository,reviewRepository,spotifyRepository,followRepository})=> {
    ...
    if(await reviewRepository.getByUserAndId(idOeuvre,id_utilisateur)) throwStatusCode(403,"vous avez déjà posté une review")
    ...
    return reviewSerializer(review,rawOeuvre,review.utilisateur,false)
}