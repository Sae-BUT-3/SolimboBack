...
const serializeReview = (rawReview,rawOeuvre,utilisateur,doesUserLike,comments) => {
    ...
    return new ReviewPublic(rawReview, rawOeuvre, new UserPublic(utilisateur),doesUserLike,comments)
}
