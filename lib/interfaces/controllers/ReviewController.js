...
const likeReview = require("../../application/use_cases/solimbo/review/likeReview");
const getReviewLikes = require("../../application/use_cases/solimbo/review/getReviewLikes");
const getUserReviews = require("../../application/use_cases/solimbo/review/getUserReviews");
...
module.exports = {
    ...
    async getReview(request,handler){
        try{
            ...
            return handler.response(await getReview(id,token, serviceLocator)).code(200)
        }catch(error){
            return handleError(error)
        }
    },
