...
module.exports = class extends userRepository {
  ...
  async updateUser(user){
    const { pseudo, email, password,alias, bio, id_role,ban_until,token,refresh_token,confirmed,confirmToken,photo, photo_temporaire } = user;
    const seqUser = await this.model.findOne({
      where: {
    ...
    seqUser.confirm_token = confirmToken
    seqUser.photo = photo
