...
module.exports = class {
    ...
    getReviewComments(id_review,id_utilisateur,fetchPrivate,page,pageSize,orderByLike) {
        throw new Error('ERR_METHOD_NOT_IMPLEMENTED');
    }
    getCommentsComments(id_reponse,id_utilisateur,fetchPrivate,page,pageSize,orderByLike) {
        throw new Error('ERR_METHOD_NOT_IMPLEMENTED');
    }
